...
type
  ...
  public
    ...
    function ParseJsonPlayer(const JsonObj: TJSONObject; Player: PlayerPiece): TJsonObject;
...
function TJsonFileManager.ParseJsonPlayer(const JsonObj: TJSONObject; Player: PlayerPiece): TJSONObject;
var
  playerName: string;
